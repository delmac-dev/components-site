        ...
        <div className="relative w-[640px] min-h-[240px] rounded-lg bg-card border border-border overflow-hidden">
            ...
            <div className="w-full min-h-full p-5">
                <div className="w-full mb-4">
                    <label htmlFor="school" className='block mb-3 text-sm font-semibold text-card-foreground'>School Name</label>
                    <Input id="school" type="text" className="w-3/4" />
                </div>
                <div className="w-full mb-4">
                    <label htmlFor="motto" className='block mb-3 text-sm font-semibold text-card-foreground'>Motto</label>
